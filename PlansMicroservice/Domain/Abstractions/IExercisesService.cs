...
{
    Task<Guid> CreateExerciseAsync(string name, string muscleGroup, CancellationToken ct);
    ...
    Task<Guid> UpdateExerciseAsync(Guid id, string name, string muscleGroup, CancellationToken ct);
