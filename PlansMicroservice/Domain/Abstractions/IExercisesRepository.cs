...
{
    Task<Guid> CreateAsync(string name, string muscleGroup, string description, CancellationToken ct);
    ...
    Task<int> UpdateAsync(Guid id, string name, string muscleGroup, string description, CancellationToken ct);
